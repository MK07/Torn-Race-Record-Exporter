...
Install Violent Monkey (or any user script manager) first: [Violent Monkey](https://violentmonkey.github.io/get-it/)

Install [User script](https://github.com/MK07/Torn-Race-Record-Exporter/raw/refs/heads/main/Race%20Exporter.user.js)
...
Subsequently, clicking this button will upload your log to the drive, it may take a few seconds to upload it. You will see a dialogue box informing you of your success.

The sheets are updated every 12 hours, so it won't update immediately.

Google Sheet: [Link](https://docs.google.com/spreadsheets/d/18cKMqyWrXA9O-7aA1wXpI3972xVrzAXms8-PhzKenzI/edit?usp=sharing)

## Support

Report issues [here](https://github.com/MK07/Torn-Race-Record-Exporter/issues/new)
